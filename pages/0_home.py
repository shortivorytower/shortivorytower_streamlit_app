...
其實而家寫乜都勁唔過 AI，何況如果想睇真人 content 大家都係即食睇片，咁仲寫嚟做乜？

呢個 blog 有幾個目的：

1. 主要係我自己嘅紀錄，寫低一路以嚟用家技術上嘅 know-how，又或者一啲我覺得有趣嘅嘢。

1. 畀少少希望一啲同我以前一樣、數學OK嘅中學生 —— 你嘅出路唔一定只係做醫生或律師，或者跟住個hype去搞 AI。Apply數學喺金融上面，雖然未必一定係炒賣，但一樣可以搵到食。

香港人梗係用廣東話啦，我係專登用廣東話寫嘅！

個repo啲嘢如果覺得啱用嘅可以隨便抄，不過自己check清楚有冇bug或計錯數，如發現有錯唔該都順便話聲我聽。
